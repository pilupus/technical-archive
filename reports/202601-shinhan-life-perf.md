...
| 단계 | 주요 기술 조치 (Action Item) | Scripting | Rendering | Painting | **Total** |
| :--- | :--- | :---: | :---: | :---: | :---: |
| **0. 초기상태** | 최적화 미적용 및 복잡한 제약 조건 검증 오버헤드 | 15,551 | 1,478 | 352 | **20,658** |
| **1. 기초 최적화** | **Native Loop** 전환, 요소 캐싱, **`detach/append` 도입** | 11,048 | 984 | 106 | **14,581** |
| **2. 알고리즘 고도화**| **In-memory Hash Map** 설계 ($O(n) \to O(1)$ 전환) | **2,804** | 1,073 | 121 | **6,724** |
| **3. 안정성 확보** | 정합성 리스크에 따른 **`detach` 패턴 전략적 철회** | 3,377 | 279 | 1,388 | **8,330** |
| **4. 최종 안정화** | **`hide/show` 패턴**으로 Reflow 국소화 및 **수동 자원 해제** | **2,629** | **1,042** | **68** | **6,062** |

### 3.1. 성능 최적화 데이터 시각화 (Mermaid)
...
gantt
    ...
    section Step 4 (최종)
    Scripting (2,629)  :e1, 2025-01-01, 26ms
    Rendering (1,042) :e2, after e1, 10ms
    Painting (68)    :e3, after e2, 1ms
```
...
graph LR
    ...
    S4["<b>Step 4 (Final)</b><br/>6,062ms"]
...
```
### 3.2. 메모리 관리 및 자원 해제 시각화 (Mermaid)
